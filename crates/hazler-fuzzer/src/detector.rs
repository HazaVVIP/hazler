...
impl BolaDetector {
    ...
    pub fn compare_responses(
        ...
        let content_similarity = self.calculate_content_similarity(&response1.body, &response2.body);
        
        let similarity = (size_similarity + content_similarity) / 2.0;
        
        let is_suspicious = status_same 
...
mod tests {
    ...
    fn test_compare_responses_suspicious() {
        ...
        assert!(comparison.is_suspicious, "Should detect suspicious similarity");
    ...
    fn test_compare_responses_not_suspicious() {
        ...
        assert!(!comparison.is_suspicious, "Should not flag different statuses");
    }
    ...
    fn test_detect_bola() {
        ...
        let responses = vec![
            Response::new("https://api.example.com/user/1".to_string(), 200, "User data".to_string()),
            Response::new("https://api.example.com/user/2".to_string(), 200, "User data".to_string()),
            Response::new("https://api.example.com/user/3".to_string(), 200, "User data".to_string()),
        ];
